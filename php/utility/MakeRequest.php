...
// FreeGames SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FreeGamesMakeRequest
{
    public static function call(FreeGamesContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FreeGamesResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FreeGamesResponse($fetched);
        } else {
