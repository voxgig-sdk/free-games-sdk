...
// FreeGames SDK streaming feature
...
class FreeGamesStreamingFeature extends FreeGamesBaseFeature
{
    ...
    private function _iterate(FreeGamesResult $result): \Generator
    {
    ...
    private function _streamable(FreeGamesContext $ctx): bool
    {
