...
class FreeGamesTimeoutFeature extends FreeGamesBaseFeature
{
    ...
    private function _with_timeout(FreeGamesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FreeGamesContext $_ctx, float $ms): void
    {
        $client = $this->client;
