...
class GiveawayEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = FreeGamesSDK::test($seed, null);
        $seen = iterator_to_array($base->Giveaway(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->Giveaway(null)->stream("list", null, null) as $item) {
