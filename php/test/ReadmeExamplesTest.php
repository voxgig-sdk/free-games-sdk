...
// FreeGames SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FreeGamesSDK::test)
...
{
    private const SDK_CLASS = 'FreeGamesSDK';
    ...
    private const SDK_BASE = 'freegames_sdk';
