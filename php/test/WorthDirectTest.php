...
class WorthDirectTest extends TestCase
{
    public function test_direct_load_worth(): void
    {
        $setup = worth_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-worth", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
