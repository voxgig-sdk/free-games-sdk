...
function envOverride(m) {
    if ('TRUE' === process.env.FREE_GAMES_TEST_LIVE ||
        'TRUE' === process.env.FREE_GAMES_TEST_OVERRIDE) {
    ...
    m.FREE_GAMES_TEST_EXPLAIN = process.env.FREE_GAMES_TEST_EXPLAIN || m.FREE_GAMES_TEST_EXPLAIN;
    return m;
}
