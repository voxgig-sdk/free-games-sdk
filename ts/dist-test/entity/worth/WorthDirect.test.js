...
(0, node_test_1.describe)('WorthDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-worth', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-worth', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['FREE_GAMES_TEST_WORTH_ENTID'];
...
//# sourceMappingURL=WorthDirect.test.js.map