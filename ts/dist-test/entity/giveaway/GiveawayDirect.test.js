...
(0, node_test_1.describe)('GiveawayDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.FreeGamesSDK({
    ...
    (0, node_test_1.test)('direct-load-giveaway', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-giveaway', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-giveaway', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-giveaway', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.FREE_GAMES_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.FreeGamesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['FREE_GAMES_TEST_GIVEAWAY_ENTID'];
    ...
    const client = new __1.FreeGamesSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GiveawayDirect.test.js.map