...
The Golang SDK for the FreeGames API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/free-games-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/free-games-sdk=../path/to/github.com/voxgig-sdk/free-games-sdk
```
...
```
github.com/voxgig-sdk/free-games-sdk/
...
The root package (`github.com/voxgig-sdk/free-games-sdk`) re-exports everything needed
