...
const testSeed = `map[string]any{"entity": map[string]any{"giveaway": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "worth": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
