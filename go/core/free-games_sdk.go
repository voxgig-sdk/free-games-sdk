...
func (sdk *FreeGamesSDK) OptionsMap() map[string]any {
...
func (sdk *FreeGamesSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FreeGamesSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FreeGamesSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FreeGamesSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FreeGamesSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FreeGamesSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FreeGamesSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FreeGamesSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FreeGamesSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FreeGamesSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
