...
func NewWorthEntity(client *core.FreeGamesSDK, entopts map[string]any) *WorthEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WorthEntity) GetName() string { return e.name }
...
func (e *WorthEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WorthEntity) Deleted() bool {
	return e.deleted
}


func (e *WorthEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWorthEntity(e.client, opts)
}

func (e *WorthEntity) Data(args ...any) any {
...
func (e *WorthEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Worth; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WorthEntity) DataTyped(data ...Worth) Worth {
	if len(data) > 0 {
		return typedFrom[Worth](e.Data(asMap(data[0])))
	}
	return typedFrom[Worth](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Worth (all fields
// optional at the wire level).
func (e *WorthEntity) MatchTyped(match ...Worth) Worth {
	if len(match) > 0 {
		return typedFrom[Worth](e.Match(asMap(match[0])))
	}
	return typedFrom[Worth](e.Match())
}
...
func (e *WorthEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WorthEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WorthLoadMatch and returns an Worth. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WorthEntity) LoadTyped(reqmatch WorthLoadMatch, ctrl map[string]any) (Worth, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Worth{}, err
	}
	return typedFrom[Worth](res), nil
}



func (e *WorthEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WorthEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WorthEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WorthEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WorthEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
