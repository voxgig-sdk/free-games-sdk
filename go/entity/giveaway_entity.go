...
type GiveawayEntity struct {
	name    string
	client  *core.FreeGamesSDK
...
func NewGiveawayEntity(client *core.FreeGamesSDK, entopts map[string]any) *GiveawayEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GiveawayEntity) GetName() string { return e.name }
...
func (e *GiveawayEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GiveawayEntity) Deleted() bool {
	return e.deleted
}


func (e *GiveawayEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGiveawayEntity(e.client, opts)
}

func (e *GiveawayEntity) Data(args ...any) any {
...
func (e *GiveawayEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Giveaway; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GiveawayEntity) DataTyped(data ...Giveaway) Giveaway {
	if len(data) > 0 {
		return typedFrom[Giveaway](e.Data(asMap(data[0])))
	}
	return typedFrom[Giveaway](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Giveaway (all fields
// optional at the wire level).
func (e *GiveawayEntity) MatchTyped(match ...Giveaway) Giveaway {
	if len(match) > 0 {
		return typedFrom[Giveaway](e.Match(asMap(match[0])))
	}
	return typedFrom[Giveaway](e.Match())
}
...
func (e *GiveawayEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GiveawayEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GiveawayLoadMatch and returns an Giveaway. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GiveawayEntity) LoadTyped(reqmatch GiveawayLoadMatch, ctrl map[string]any) (Giveaway, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Giveaway{}, err
	}
	return typedFrom[Giveaway](res), nil
}




func (e *GiveawayEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// GiveawayListMatch and returns []Giveaway. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GiveawayEntity) ListTyped(reqmatch GiveawayListMatch, ctrl map[string]any) ([]Giveaway, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Giveaway](res), nil
}



func (e *GiveawayEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GiveawayEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GiveawayEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GiveawayEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
