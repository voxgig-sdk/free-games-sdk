...
class WorthEntity
  ...
  # @return [Worth, Hash] the current Worth data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Worth fields)
  def match_get
  ...
  # Load a single Worth.
  #
  # @param reqmatch [WorthLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Worth.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Worth, Hash] the loaded Worth; raises FreeGamesError on failure
