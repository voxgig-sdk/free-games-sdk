...
type Args struct {
	Entity string         `json:"entity" jsonschema:"giveaway | worth"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FreeGamesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-games_list",
		Description: "List records from FreeGames. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-games_load",
		Description: "Load a single record from FreeGames. " +
...
func runOp(client *sdk.FreeGamesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FreeGamesSDK, name string) (sdk.FreeGamesEntity, error) {
	switch strings.ToLower(name) {
	case "giveaway":
		return client.Giveaway(nil), nil
	case "worth":
		return client.Worth(nil), nil
