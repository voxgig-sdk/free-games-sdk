...
func registerSDKWords(r *eng.Registry, client *sdk.FreeGamesSDK) {
...
func runOp(client *sdk.FreeGamesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
