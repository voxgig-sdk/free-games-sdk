...
local FreeGamesSDK = {}
FreeGamesSDK.__index = FreeGamesSDK
...
FreeGamesSDK._make_feature = _make_feature


function FreeGamesSDK.new(options)
  local self = setmetatable({}, FreeGamesSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function FreeGamesSDK:options_map()
...
function FreeGamesSDK:get_utility()
  return Utility.copy(self._utility)
end


function FreeGamesSDK:get_root_ctx()
  return self._rootctx
end


function FreeGamesSDK:prepare(fetchargs)
...
function FreeGamesSDK:direct(fetchargs)
...
-- by passing it.
function FreeGamesSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function FreeGamesSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "FreeGamesSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function FreeGamesSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = FreeGamesSDK.new(sdkopts)
  sdk.mode = "test"
