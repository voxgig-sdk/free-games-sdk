...
describe("GiveawayDirect", function()
  it("should direct-list-giveaway", function()
    local setup = giveaway_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-giveaway", setup.live and "live" or "unit")
  ...
  it("should direct-load-giveaway", function()
    local setup = giveaway_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-giveaway", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function giveaway_direct_setup(mockres)
