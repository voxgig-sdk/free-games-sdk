...
describe("WorthDirect", function()
  it("should direct-load-worth", function()
    local setup = worth_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-worth", setup.live and "live" or "unit")
...
function worth_direct_setup(mockres)
