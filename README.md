...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/free-games` | `npm install @voxgig-sdk/free-games` |
| Python | `voxgig-sdk-free-games` | `pip install voxgig-sdk-free-games` |
| PHP | `voxgig-sdk/free-games` | `composer require voxgig-sdk/free-games` |
| Golang | `github.com/voxgig-sdk/free-games-sdk/go` | `go get github.com/voxgig-sdk/free-games-sdk/go` |
| Ruby | `voxgig-sdk-free-games` | `gem install voxgig-sdk-free-games` |
| Lua | `voxgig-sdk-free-games` | `luarocks install voxgig-sdk-free-games` |
