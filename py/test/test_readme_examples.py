# FreeGames SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FreeGamesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FreeGamesSDK(...) and FreeGamesSDK.test(...) become
#      FreeGamesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "freegames_sdk"
_SDK_CLASS = "FreeGamesSDK"
