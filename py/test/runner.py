...
class FreeGamesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeGamesTestRunner.getenv("FREEGAMES_TEST_LIVE")
        override = FreeGamesTestRunner.getenv("FREEGAMES_TEST_OVERRIDE")
        ...
        explain = FreeGamesTestRunner.getenv("FREEGAMES_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["FREEGAMES_TEST_EXPLAIN"] = explain
