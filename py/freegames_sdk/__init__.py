...
from freegames_sdk.utility import register

# Load features
from freegames_sdk.feature.base_feature import FreeGamesBaseFeature
from freegames_sdk.features import _has_feature, _make_feature
...
class FreeGamesSDK:
    ...
    def get_utility(self):
        return FreeGamesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FreeGamesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Giveaway(self, data=None) -> "GiveawayEntity":
        ...
        from freegames_sdk.entity.giveaway_entity import GiveawayEntity
        return GiveawayEntity(self, data)


    def Worth(self, data=None) -> "WorthEntity":
        """Entity factory: client.Worth().list() / client.Worth().load({"id": ...})."""
        from freegames_sdk.entity.worth_entity import WorthEntity
