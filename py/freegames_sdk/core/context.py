...
from freegames_sdk.core.control import FreeGamesControl
...
from freegames_sdk.core.helpers import get_ctx_prop, to_map
...
class FreeGamesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, FreeGamesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FreeGamesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FreeGamesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FreeGamesError(code, msg, self)
