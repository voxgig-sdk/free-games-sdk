...
|---|---|---|
| `ts/` | @voxgig-sdk/free-games-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/free-games-sdk \
      --repository voxgig-sdk/free-games-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/free-games-sdk` shows it, and
`npm trust revoke @voxgig-sdk/free-games-sdk --id=<id>` removes it.
