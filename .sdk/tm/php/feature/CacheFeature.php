...
class FreeGamesCacheFeature extends FreeGamesBaseFeature
{
    ...
    private function _through(FreeGamesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
