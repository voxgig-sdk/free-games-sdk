...
// FreeGames SDK ratelimit feature
...
class FreeGamesRatelimitFeature extends FreeGamesBaseFeature
{
    ...
    private function _acquire(FreeGamesContext $ctx): void
    {
    ...
    private function _track(FreeGamesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
