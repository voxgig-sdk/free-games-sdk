...
class FreeGamesProxyFeature extends FreeGamesBaseFeature
{
    ...
    public function init(FreeGamesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FreeGamesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
