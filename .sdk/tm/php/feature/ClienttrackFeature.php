...
// FreeGames SDK clienttrack feature
...
class FreeGamesClienttrackFeature extends FreeGamesBaseFeature
{
    ...
    public function PostConstruct(FreeGamesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FreeGames-SDK';
