...
class FreeGamesRbacFeature extends FreeGamesBaseFeature
{
    ...
    private function _required(FreeGamesContext $ctx): ?string
    {
    ...
    private function _reject(FreeGamesContext $ctx, string $required): void
    {
    ...
    private function _track(FreeGamesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
