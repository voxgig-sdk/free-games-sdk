...
class FreeGamesGraphql
{
    ...
    // equivalent.
    public static function body(FreeGamesContext $ctx): mixed
    {
    ...
    public static function errors(FreeGamesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
