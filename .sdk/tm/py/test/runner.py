...
class FreeGamesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeGamesTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = FreeGamesTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = FreeGamesTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
