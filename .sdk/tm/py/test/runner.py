...
class FreeGamesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeGamesTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = FreeGamesTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = FreeGamesTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
